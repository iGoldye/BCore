...
local clothing_shops = {
    {name="Change Clothes", id=73, x=1457.053, y=6359.949, z=23.835},
    --{name="Clothing Store", id=73, x=1930.519, y=3731.839, z=32.9},
    --{name="Clothing Store", id=73, x=1693.26, y=4822.27, z=42.15},
    --{name="Clothing Store", id=73, x=125.83, y=-223.16, z=54.6},
    --{name="Clothing Store", id=73, x=-710.16, y=-153.26, z=37.45},
    --{name="Clothing Store", id=73, x=-821.69, y=-1073.90, z=11.4},
    --{name="Clothing Store", id=73, x=-1192.81, y=-768.24, z=17.35},
    --{name="Clothing Store", id=73, x=4.25, y=6512.88, z=31.95},
    --{name="Clothing Store", id=73, x=425.471, y=-806.164, z=29.55},
    --{name="Clothing Store", id=73, x=-1101.017, y=2710.264, z=19.2},
    --{name="Clothing Store", id=73, x=1196.877, y=2709.760, z=38.3},
}
incircle = false
        ...
        for k,v in ipairs(clothing_shops) do
            if(Vdist(pos.x, pos.y, pos.z, v.x, v.y, v.z) < 15.0)then
                ...
                if(Vdist(pos.x, pos.y, pos.z, v.x, v.y, v.z) < 2.0)then
                    DrawText3D(v.x, v.y, v.z + 1, 255, 255, 255, "Press ~INPUT_CONTEXT~ to customise your character.")
                ...
                elseif(Vdist(pos.x, pos.y, pos.z, v.x, v.y, v.z) >= 2.0)then
                    ...
                    if (GetDistanceBetweenCoords(pos.x, pos.y, pos.z, v.x, v.y, v.z, true) < 8.0) then
                        DrawText3D(v.x, v.y, v.z + 1, 0, 0, 0, "Press ~INPUT_CONTEXT~ to customise your character.")
                    end
